...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/barang/create') }}" class="btn btn-primary">Tambah Data</a>
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->jumlah}}</td>
                                            <td>
                                                <a href="/main/barang/{{ $row->id }}" class="btn btn-primary btn-sm"><i
                                                        class="fa fa-eye"></i></a>
                                                <a href="/main/barang/{{ $row->id }}/edit"
