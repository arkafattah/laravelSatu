...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/jenis_barang/create') }}" class="btn btn-primary">Tambah Data</a>
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->nama }}</td>
                                            <td>
                                                <a href="/main/jenis_barang/{{ $row->id }}" class="btn btn-primary btn-sm"><i
                                                        class="fa fa-eye"></i></a>
                                                <a href="/main/jenis_barang/{{ $row->id }}/edit"
                                                    class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                                <form action="{{ route('jenis_barang.destroy', $row->id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('delete')
